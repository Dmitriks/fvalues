...
INSERT IGNORE INTO `symbol` VALUES (1,'EURUSD','Euro vs US Dollar'),(2,'GBPUSD','Great Britain Pound vs US Dollar'),(3,'USDJPY','US Dollar vs Japanese Yen'),(4,'USDCHF','US Dollar vs Swiss Franc'),(5,'GOLD','Gold'),(6,'SILVER','Silver'),(7,'#CL','Crude Oil Light Sweet'),(8,'#NG','Natural Gas');
